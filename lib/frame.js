...
exports.createWebSocketFrame = function(buffer) {
	return new WebSocketFrame(buffer);
};

function WebSocketFrame(buffer) {
	this.fin = 0;
	this.opcode = 0;
	this.mask = 0;
...
WebSocketFrame.prototype.setFin = function(bFin) {
	this.fin = bFin == true;

	return this;
};

WebSocketFrame.prototype.setOpcode = function(nibbleOpcode) {
...
WebSocketFrame.prototype.setMask = function(bMask) {
	this.mask = true == bMask;
	
	return this;
};

WebSocketFrame.prototype.setPayloadLength = function(length) {
	this.payloadLength = length;
	
	return this;	
};

WebSocketFrame.prototype.setMaskingKey = function(maskingKey) {
	this.maskingKey = 0xFFFFFFFF & maskingKey;
	
	return this;
};

WebSocketFrame.prototype.setPayloadData = function(data) {
	this.payloadData = data;
	
	return this;
};

WebSocketFrame.prototype.build = function() {
...
WebSocketFrame.prototype.getPayloadData = function() {
